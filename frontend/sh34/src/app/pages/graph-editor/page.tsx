...
function Body() {
  ...
  const [plotOptionsContent,setPlotOptionsContent] = useState(<GeneralGraphOptions setSelectedIndicator={setSelectedIndicator} />);
  ...
  return (
    <div className="font-league bg-white flex flex-row flex-1 overflow-auto">
        <Sidebar switchPageFunc={setPlotOptionsContent} selectedIndicator={selectedIndicator} setSelectedIndicator={setSelectedIndicator} />
