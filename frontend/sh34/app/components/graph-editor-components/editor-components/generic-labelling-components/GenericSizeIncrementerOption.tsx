    ...
    return(
        <div className="flex items-center gap-x-1 ml-3 mr-3">
            ...
            <div className="flex items-center gap-x-1">
                <input onBlur={handleBlur} onKeyDown={handleKeyDown} maxLength={7} placeholder="" className="text-right font-medium placeholder-[#ACACAC] h-[35px] w-[100px] bg-[#DCDCDC] rounded-lg flex items-center px-2 border-2 border-[#B3B3B3] focus:ring-2 focus:ring-RES_ORANGE focus:outline-none focus:border-none" />
