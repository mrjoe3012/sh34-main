    ...
    return(
        <div className=''>
          <div className='grid grid-cols-7 p-4'>
            ...
            <div className='col-start-5 flex justify-end mr-[-15px] mt-[3px]'>
              <h2 className='text-lg inline font-medium placeholder-[#ACACAC]'>Sort by</h2>
            </div>

            <div className='col-start-6 flex justify-center'>
               <select placeholder="Select an option" className="font-medium placeholder-[#ACACAC] h-[35px] w-[150px] bg-[#EAEAEA] rounded-lg flex items-center pl-4  border-[#B3B3B3] focus:ring-2 focus:ring-RES_ORANGE focus:outline-none focus:border-none"
